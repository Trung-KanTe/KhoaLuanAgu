  ...
  ngOnInit(): void {
    this.router.events.subscribe(event => {
      if (event instanceof NavigationEnd) {
        this.isUserView = event.url.includes('/admin/user') || event.url.includes('/admin/brand') || event.url.includes('/admin/role') || event.url.includes('/admin/importProduct') || event.url.includes('/admin/product') || event.url.includes('/admin/promotion') || event.url.includes('/admin/wareHouse') || event.url.includes('/admin/store') || event.url.includes('/admin/partner') || event.url.includes('/admin/classification') || event.url.includes('/admin/category');     
        if (!this.isUserView) {
          setTimeout(() => {
            this.renderCharts();
